...
std::unique_ptr<AudioManager> AudioManager::s_Instance;
...
void AudioManager::Initialize()
{
	...
	s_Instance = std::unique_ptr<AudioManager>(new AudioManager);
}
...
//	Assert(false);	// Fix me: we don't want to create this dependency
	...
	m_3DAudioMatrixCoeficients = std::unique_ptr<FLOAT32[]>(new FLOAT32[2 * m_VoiceDetails.InputChannels]);
...
Sound& AudioManager::GetCachedSound(const std::wstring& path, bool loopForever, bool hasReverb)
{
